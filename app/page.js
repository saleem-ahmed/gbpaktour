              ...
              <>
                <div className="w-full md:w-1/4 sm:w-1/2 shadow-lg h-[100%] flex flex-col gap-3 bg-white dark:bg-black">
                  ...
                  <div className="flex flex-col gap-1 px-3 py-3">
                    <h3 className="font-bold text-blue-700">{items.title}</h3>
                    <p className="text-blue-700">{items.desc}</p>
                  </div>
                </div>
              </>
            ))}
            ...
            {Services.map((service) => (
              <>
                <div class="space-y-4 flex flex-col items-center">
                  ...
                  <h3 class="text-2xl font-bold leading-tight text-gray-900 hover:text-blue-700 dark:text-white">
                    {service.name}
                  </h3>
