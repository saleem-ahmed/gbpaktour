...
import HedaerImg from "@/public/bgPak.png";
  ...
  const teamMembers = [
    {
      ...
      facebooklink: "",
      githublink: "https://github.com/shoaibbaig987",
    },
    {
      img: Img1,
      name: "Shoaib Baig",
      ...
      <section class="bg-white dark:bg-gray-900 antialiased">
        <div class="max-w-screen-xl px-4 py-8 mx-auto lg:px-6 sm:py-16 lg:py-24">
          <div class="max-w-2xl mx-auto text-center">
            <h2 class="text-3xl font-extrabold leading-tight tracking-tight text-[#0e7490] sm:text-4xl dark:text-white">
              Our Services
            </h2>
            ...
            {Services.map((service) => (
              <>
                <div class="space-y-4 flex flex-col items-center">
                  ...
                  <h3 class="text-2xl font-bold leading-tight text-[#0e7490] hover:text-[#0e7490] dark:text-white">
                    {service.name}
                  </h3>
                  <p class="text-lg font-normal text-gray-500 hover:text-blue-500 dark:text-gray-400">
                    {service.description}
                  </p>
                </div>
              </>
      ...
      <section class="bg-white dark:bg-gray-900">
        <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-6">
          <div class="mx-auto mb-8 max-w-screen-sm lg:mb-16">
            <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-[#0e7490] dark:text-white">
              Our Amazing Team
            </h2>
              ...
              <>
                <div class="text-center text-gray-500 dark:text-gray-400">
                  <Image
                    ...
                    alt="Bonnie Avatar"
                  />
                  <h3 class="mb-1 text-2xl font-bold tracking-tight text-[#0e7490] dark:text-white">
                  ...
                  <ul class="flex justify-center mt-4 space-x-4">
                    <li>
                      <a
                        href="#"
                        class="text-[#39569c] hover:text-[#0e7490] dark:hover:text-white"
                      >
                        <svg
                          class="w-6 h-6"
                          fill="currentColor"
                    ...
                    <li>
                      <a
                        href="#"
                        class="text-[#00acee] hover:text-[#0e7490] dark:hover:text-white"
                      >
                        <svg
                          class="w-6 h-6"
                          fill="currentColor"
                    ...
                    <li>
                      <a
                        href="#"
                        class="text-[#0e7490] hover:text-[#0e7490] dark:hover:text-white dark:text-gray-300"
                      >
                        <svg
                          class="w-6 h-6"
                          fill="currentColor"
                    ...
                    <li>
                      <a
                        href="#"
                        class="text-[#ea4c89] hover:text-[#0e7490] dark:hover:text-white"
                      >
                        <svg
                          class="w-6 h-6"
                          fill="currentColor"
